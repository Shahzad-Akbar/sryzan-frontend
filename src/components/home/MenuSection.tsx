    ...
    <section className="mx-auto px-4 py-16 bg-[#F8FAFC]">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold">
          <span className="text-primary-2">Menu</span> That{' '}
          <span className="text-primary-2">Always</span> Make
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {menuItems.map((item) => (
          <div
            key={item.id}
            className="bg-white rounded-2xl p-4 relative group hover:shadow-lg transition-all"
          >
