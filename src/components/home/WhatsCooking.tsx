      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {cookingItems.map((item) => (
          <div
            ...
            style={{
              background:
                'linear-gradient(179.69deg, rgba(255, 255, 255, 0) -31.53%, #FFD166 303.75%)',
            }}
          >
            <div className="relative mb-6 flex justify-center">
              ...
              <button className="absolute bottom-2 right-[55px] bg-secondary-1 text-neutral-white w-12 h-12 rounded-full flex items-center justify-center shadow-md hover:bg-secondary-1/90 transition-colors">
            ...
            <div className="h-[368px] rounded-[20px] p-4">
              ...
              <h3 className="text-xl font-poppins font-semibold text-neutral mb-2">{item.name}</h3>
              <p className="text-neutral/70 text-sm leading-relaxed">{item.description}</p>
            </div>
          </div>
        ))}
      </div>
