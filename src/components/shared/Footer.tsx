        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/about" className="text-neutral hover:text-primary-2">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-neutral hover:text-primary-2">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-neutral hover:text-primary-2">
                  Services
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/partnership" className="text-neutral hover:text-primary-2">
                  Partnership
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-neutral hover:text-primary-2">
                  Terms of Use
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-neutral hover:text-primary-2">
                  Privacy
                </Link>
              </li>
            </ul>
