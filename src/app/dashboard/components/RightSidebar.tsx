...
const orderItems = [
  { name: 'Pepperoni Pizza', price: '70.59', image: '/assets/images/dishes/pepperoni-pizza.svg' },
  { name: 'Cheese Burger', price: '65.49', image: '/assets/images/dishes/cheese-burger.svg' },
  { name: 'Vegan Pizza', price: '50.09', image: '/assets/images/dishes/vegan-pizza.svg' },
]

export function RightSidebar({ isOpen, onToggle }: RightSidebarProps) {
  return (
    <div className="relative">
      <div className={`${isOpen ? 'w-80' : 'w-5'} bg-white h-screen sticky top-0 transition-all duration-300 overflow-hidden`}>
